 ...
 export default function Footer() {
    return (
        ...
        <footer className="bg-orange-700 border-y">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-black-500 font-medium">
                                <li className="mb-2">
                                    <a
                                        href="https://github.com/Priyanshu1119?tab=repositories"
                                    ...
                                    >
                                     ...
                                     <br />
                                    <a
                                        href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJTJndJFVksLtzmDMKmBdzGnDfZmhLpRHXsxpWrrncHQnvKzgmsdZFLKrXcgTjQqWGmLcDB"
                                        className="hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-black-500 sm:text-center">
                        © 2025
                        <a href="priyanshudubey2026@gmail.com" className="hover:underline">
                            Priyanhshu Dubey
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-white-500 hover:text-gray-900">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
